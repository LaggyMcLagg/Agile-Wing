...
<div class="container" id="listForm">
    <div class="row"> 
        ...
        <div class="col-md-4"> 
            ...
            <!-- FORM -->
            <form action="{{ route('hour-block-course-classes.store') }}" id="controlForm" method="POST">
                @csrf
                ...
                <!-- Course ID -->
                <label for="id">Hour Block Course Classes ID: </label>
        ...
        <div class="col-md-8">
            ...
            <table id="sortable-table" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td data-name="id">{{ $hourBlockCourseClass->id }}</td>
